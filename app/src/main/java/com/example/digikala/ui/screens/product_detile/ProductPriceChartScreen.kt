...
@Composable
fun ProductPriceChartScreen(navController: NavController, jsonString: String) {
            ...
            chart = lineChart() + lineChart(
                lines = listOf(
                    lineSpec(
                        ...
                        lineBackgroundShader = verticalGradient(
                            colors = arrayOf(
                                androidx.compose.ui.graphics.Color.Blue.copy(alpha = 0.4f),
                                androidx.compose.ui.graphics.Color.Blue.copy(alpha = 0f),
                            ),
                        ),
                    ),
                ),
